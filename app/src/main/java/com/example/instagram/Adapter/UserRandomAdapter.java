...
public class UserRandomAdapter extends RecyclerView.Adapter<UserRandomAdapter.ViewHolder> {
    ...
    public UserRandomAdapter(Context context, List<User> userList, boolean isFragment) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView imageRemove,imageRandom;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);

            imageRemove = itemView.findViewById(R.id.imageRemov);
